function [E,M,Cv,Chi] = StatisticPropertiesBrick(spin,kT,J,testingIter,testingPerEnergy)
...
for testidex = 1: testingIter
    spin = metropolisBrick(spin, kT,J, testingPerEnergy);
    Energy(testidex)        = energyIsingBrick(spin, J);
