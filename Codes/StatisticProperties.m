function [E,M,Cv,Chi] = StatisticProperties(spin,kT,J,testingIter,testingPerEnergy)
...
for testidex = 1: testingIter
    spin = metropolis(spin, kT,J, testingPerEnergy);
    Energy(testidex)        = energyIsing(spin, J);
